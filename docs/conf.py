...
# -*- coding: utf-8 -*-
"""
OrionExample documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, '..', 'OrionExample'))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, '..'))
sys.path.insert(0, src_path)

import OrionExample  # noqa
...
project = u'OrionExample'
_full_version = OrionExample.__version__
author = OrionExample.__author__
copyright = OrionExample.__copyright__
...
htmlhelp_basename = 'OrionExample-doc'
...
latex_documents = [
    (master_doc, 'OrionExample.tex', u'OrionExample Documentation',
     u'authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'OrionExample', 'OrionExample Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OrionExample', 'OrionExample Documentation',
     author, 'OrionExample', OrionExample.__descr__,
     'Miscellaneous'),
]
